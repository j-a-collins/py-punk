...
PyPunk is a project aimed at building and training a self-driving car inside _Cyberpunk 2077_. The goal is to train a neural network to create an autonomous vehicle capable of navigating the complex and dynamic environment of *Night City*. This project is still in progress...
